...
class TennisGame {
  ...
  playSet(set: Set) {
    while (!set.winner) {
      ...
      if (set.team1Games >= 5 && set.team1Games - set.team2Games >= 2) {
        set.winner = this.team1.name;
      } else if (set.team2Games >= 5 && set.team2Games - set.team1Games >= 2) {
        set.winner = this.team2.name;
      } else if (set.team1Games === set.team2Games && set.team1Games === 5) {
